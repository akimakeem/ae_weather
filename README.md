...
- Upgraded to airflow:2.3.0 in the docker compose file
- Setup a python virtual environment (.bungalow_venv)
- Install apache-airflow & apache-airflow-providers-postgres in the venv
- State & Measure unit not present in API response
