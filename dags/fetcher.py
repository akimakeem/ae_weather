...
def ingest_api_data(city_ids: t.List[str]) -> t.List[t.Tuple]:
    ...
    for city_id in city_ids:
        payload = get_current_weather(city_id=city_id, api_key="00ce8ad34740b612ac1c35a7837eb405")
        if payload:
            rows.append(
                (
                    payload["id"],
...
with DAG(
    ...
    t2 = PythonOperator(
        ...
        retries=0,
        op_kwargs={
            "city_ids": ["5992996", "6058560", "5969785", "6167865", "5894171", "6091104", "6094817", "6075357", "5907990"],  # KW, London (ON)
        },
    )
